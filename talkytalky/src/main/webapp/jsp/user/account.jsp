...
<body>
	...
	<div class="nav-wrapper  cyan darken-3">
		...
		<ul id="nav-mobile" class="left hide-on-med-and-down">
			...
			<li>
				...
				</ul> <a class="btn dropdown-button" href="#!" data-activates="dropdown2">Ilmoitukset<i
	...
	<div id="sisalto">
		...
		<h2>Kayttaja</h2>
		<br> <br>
		<div class="keskusteluPainike">
			<a class="waves-effect waves-light btn " href="create">Tee
				keskustelu</a>
		</div>
		<br> <br> <br>
				...
				<tbody>
					<c:forEach items="${keskustelut}" var="k">
						...
						<td><c:out value="${k.keskustelu.pvmStr}"></c:out></td>
							...
							<td><c:out value="${k.aloittaja.etunimi}"></c:out> <c:out
									value="${k.aloittaja.sukunimi}"></c:out></td>
									<td><div class="chip">
									<a href=""> <img> <c:out
											value="${k.keskustelu.nimi}"></c:out>
									</a>
								</div></td>
